        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">歌曲信息展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              ...
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('gequxinxi','新增')" @click="jump('../gequxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../gequxinxi/detail.jsp?id='+item.id)">
                      <a href="#" class="ng-prsliik">
                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                          <img :src="item.xiangguantupian?item.xiangguantupian.split(',')[0]:''" />
                        </span>
                    ...
                    <div class="ng-prslist-tit" @click="jump('../gequxinxi/detail.jsp?id='+item.id)"><span>{{item.gequmingcheng}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#gequmingcheng').val()) {
          param['gequmingcheng'] = jquery('#gequmingcheng').val() ? '%' + jquery('#gequmingcheng').val() + '%' : '';
        }  
        if (jquery('#gequleibie').val()) {
          param['gequleibie'] = jquery('#gequleibie').val() ? '%' + jquery('#gequleibie').val() + '%' : '';
        }  
        if (jquery('#geshou').val()) {
          param['geshou'] = jquery('#geshou').val() ? '%' + jquery('#geshou').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('gequxinxi/list', 'get', param, function(res) {
