				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('gequxinxi','歌曲推荐')" @click="onAcrossTap('tuijianxinxi')" type="button" class="layui-btn">
								歌曲推荐
							</button>
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.gequmingcheng;
																																																																						// 轮播图片
					vue.swiperList = vue.detail.xiangguantupian ? vue.detail.xiangguantupian.split(",") : [];
																																																																											var swiperItemHtml = '';
