...
{
	name: '歌曲信息',
	url: './pages/gequxinxi/list.jsp'
}, 
{
	name: '推荐信息',
	url: './pages/tuijianxinxi/list.jsp'
}, 

]

var adminurl =  "http://localhost:8080/jspmg9w8z/index.jsp";
