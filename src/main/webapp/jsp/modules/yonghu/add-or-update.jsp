...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>身份证号码</label>
										<input id="shenfenzhenghaoma" name="shenfenzhenghaoma" class="form-control" placeholder="身份证号码">
									</div>
									<div class="form-group col-md-6">
										<label>手机号码</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#shenfenzhenghaoma").val(ruleForm.shenfenzhenghaoma);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shenfenzhenghaoma != null && res.data.shenfenzhenghaoma != ''){

					$("#shenfenzhenghaoma").val(res.data.shenfenzhenghaoma);
					}
